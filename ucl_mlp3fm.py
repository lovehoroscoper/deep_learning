...
if advertiser=='2997':#best 0.614140407502
    lr=0.002 
elif advertiser=='3386':#0.774065267569
    hidden1 = 300
    batch_size=1000
    lr=0.005
    lambda1=0.5
elif advertiser=='all':# 0.695
    lr=0.001
    lambda1=0.01
        
if sys.argv[2]=='mod' and advertiser=='2997':#best 0.615397800066
