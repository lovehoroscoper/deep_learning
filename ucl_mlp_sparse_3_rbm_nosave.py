...
lambda1=0.001 # 0.1                                                            #regularisation rate
hidden1 = 300 #hidden layer 1
hidden2 = 100 #hidden layer 2
acti_type='sigmoid' # tanh                                                    #activation type
...
#ww1,bb1=gbrbm.get_rbm_weights(train_file,arr,ncases=train_size,batch_size=100000,fm_model_file=fm_model_file)
